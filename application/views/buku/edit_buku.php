...
<div class="col-md-12">
  ...
  <div class="box box-info">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('buku/update'); ?>">
      <div class="box-body">
        ...
        <div class="form-group">
		  ...
		  <div class="form-group">
			  ...
			  <div class="col-sm-10">
				  <input type="file"  name="editgambarbuku" class="form-control" onchange="return masok()"  accept="image/jpeg, image/jpg, image/png" id="file">
			  </div>
		  </div>
		  ...
		  <div class="form-group" hidden>
			  <label for="inputPassword3" class="col-sm-2 control-label">Foto/ Gambar Buku</label>
			  <div class="col-sm-10">
				  <input  type="text" value="0"  name="filelawas" class="form-control"  accept="image/jpeg, image/jpg, image/png" id="filelawas">
...
<script type="text/javascript">
	function masok(){
		...
		var lawas = document.getElementById('filelawas');
